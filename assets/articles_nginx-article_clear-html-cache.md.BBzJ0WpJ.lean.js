import{_ as n,c as s,a1 as e,o as l}from"./chunks/framework.C7DD2qdS.js";const m=JSON.parse('{"title":"nginx 清除页面缓存","description":"","frontmatter":{},"headers":[],"relativePath":"articles/nginx-article/clear-html-cache.md","filePath":"articles/nginx-article/clear-html-cache.md"}'),p={name:"articles/nginx-article/clear-html-cache.md"};function i(t,a,c,r,o,d){return l(),s("div",null,a[0]||(a[0]=[e(`<h1 id="nginx-清除页面缓存" tabindex="-1">nginx 清除页面缓存 <a class="header-anchor" href="#nginx-清除页面缓存" aria-label="Permalink to &quot;nginx 清除页面缓存&quot;">​</a></h1><ul><li>有时候项目重新部署后用户端访问到的还是旧的页面，这是因为 nginx 缓存了旧的页面，所以需要清除缓存。</li></ul><h2 id="配置文件" tabindex="-1">配置文件 <a class="header-anchor" href="#配置文件" aria-label="Permalink to &quot;配置文件&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>server {</span></span>
