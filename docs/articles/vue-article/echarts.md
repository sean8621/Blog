...
<img src="./assets/echartMap.gif" width="600" height="600" alt="Echarts Map 地图">

[地图数据集及下钻对应的行政区域编码 json](https://github.com/sean8621/mapData).
...
export default {
  ...
  methods: {
    // 初始化地图
    initMap(name) {
      this.map = echarts.init(this.$refs["geoEcharts"], null, {
        renderer: "svg",
      });
      this.changeMap(name);
    },
